...
<body id="page-top">
    ...
    <div style="height: 85%;background: transparent;background-image:url(http://bit.ly/1ITWPDD);background-size:cover;"class="jumbotron">
        ...
        <div class="content-title" style="margin-top:120px;">
           A Greek touch under the blue sky
			...
			<div>
				  ...
				  <a href="#"><i style="position:static;margin-top:10%;font-size: 60px;" id="scroll" class="fa fa-angle-double-down"></i></a>
	...
	<section style="padding-top:10px;padding-bottom:60px;"id="services">
	...
	<div id="chart" class="row">
		...
		<div class="col-md-6" style="text-align:center;">
			...
			<h2 style="font-size:30px; font-weight:100;">Charters</h2><br>


					<p style="font-size:20px;">A typical day charter includes anchoring off for a refreshing swim and a snorkel, a visit to an beautiful location, a secluded beach or even neighboring island for lunch, and as much or as little sailing as you would like. Our Skipper's or Captain's have great knowledge of the Island and can suggest the ideal trip tailored to you, making it a hassle free experience, alternatively you can choose exactly where you wish to visit.
					</p>
					<p style="font-size:20px;">All our packages include a fully qualified Skipper or Captain and well equipped quality yacht, fuel & taxes, VAT, cleaning, insurance, onboard bar with soft drinks and towels.
					</p>
					<p style="font-size:20px;">We also offer <span style="font-weight:bold;">Premium & Stylish lunch Service</span> upon request, to make your day that extra bit special.
					</p>
					<p style="font-size:20px;">Why not choose one of our Catering suggestions so you can have lunch onboard, maybe swinging on anchor in a secluded bay or a recommended tavern / restaurant by the beach.
					</p>
					<p style="font-size:20px;">Whether you want a simply lunch or stylish  platter for a special occasion, we accommodate your wishes.
					</p>
					<p style="font-size:20px;">The day starts at 9:30 when you will meet your skipper or captain and get acquainted with the yacht. The yacht returns to base for 18:00, so you get a FULL days of adventure.
					</p>
					<p style="font-size:20px;">Split between groups of friends, this makes for a very enjoyable and inexpensive day out on your own private yacht!
					</p>
					<p style="font-size:20px;">Hostess service is available for an additional cost.
					</p>
					<p style="font-size:20px;">Transport can be arranged from your villa or hotel to our base if requested!
					</p>
					<p style="font-size:20px;">Just let us know your requirements and we will take care of the rest!
					</p>
		</div>
		<div class="col-md-3">
		</div>
