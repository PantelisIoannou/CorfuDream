...
<head>
    ...
    <title>Wedding or Honeymoon - Corfu Dream</title>
...
<body id="page-top">
   ...
   <div style="height: 85%;background-image:url(http://bit.ly/1U2LJwA);background-size:cover;" class="bg"></div>
...
<div class="container">
	<div class="row"style="margin-right:0px;">
		...
		<div class="">
      <h2 class="title new-title-size" style=" font-size:30px;font-weight: 300;">Wedding or Honeymoon Cruises</h2>
			<p style="padding-top:40px;">
        We are proud to offer exclusive charter arrangements for special occasions such as weddings or honeymoons.<br>

  From a stylish private tour just for the happy couple to fully fledged excursion for a small group of guests of the wedding party, we are happy to make your special occasion a memorable one! 
  <br><br>
  Contact us with your needs and leave the rest to us!</p>
 		</div>
      </section>

      <section id="contact" class="brightness" style="padding-top:8%; padding-bottom:3%; background-image:url(http://bit.ly/1U2LJwA); background-repeat:no-repeat;background-size:cover;">
