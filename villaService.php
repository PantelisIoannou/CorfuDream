...
<head>
    ...
    <title>Private Villa Service - Corfu Dream</title>
...
<body id="page-top">
   ...
   <div style="height: 85%;background-image:url(http://bit.ly/1NAPWpE);background-size:cover;" class="bg"></div>
...
<div class="container">
	<div class="row"style="margin-right:0px;">
		...
		<div class="">
      <h2 class="title new-title-size" style="font-weight: 200;">Private Villa Service</h2>
			<p style="padding-top:40px;">
        Our private villa service is available on an exclusive selected motor Absolute 45 yacht and comes with professional captain.
        <br>The yacht is at guest’s disposal for a weekly or daily use.
        <br>If possible it will be moored at the dock of your villa.
        <br>Our regular private service includes your own private yacht with Captain, insurance, taxes and towels.
        <br>Not included are fuels as well as a hostess or transfers to and from the port all of which can be easily arranged by letting us know you specific requirements.
      </p>

        <h3 style="font-size:20px;font-weight: 200;text-decoration: underline;" class="title new-title-size">Prices</h3>
        <p>Per week €11.550  <br>
        Per day:  €1.870  <br>
        Maximum number of guests: 9
			</p>
      <p>For an inquiry or further information please contact us.</p>
 		</div>
      </section>

      <section id="contact" class="brightness" style="padding-top:8%; padding-bottom:3%; background-image:url(http://bit.ly/1NAPWpE); background-repeat:no-repeat;background-size:cover;">
